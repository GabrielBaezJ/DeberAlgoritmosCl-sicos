...
{
    /// <summary>
    /// Interfaz para el algoritmo Weiler-Atherton: permite definir polígonos subject y clip y aplicar recorte.
    /// La UI valida entradas y maneja errores sin cerrar la aplicación.
    /// </summary>
    public partial class FrmWeilerAtherton : Form
    {
        ...
        private List<List<PointF>> _clippedPolygons = new List<List<PointF>>();
        ...
        private void InitializeCustom()
        {
            try
            {
                ...
                // Enable double buffering on the canvas for smoother rendering
                try
                {
        ...
        private void pnlCanvas_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (_clippedPolygons != null)
            {
                using (var pen = new Pen(Color.Red, 2f))
                {
                    foreach (var poly in _clippedPolygons)
                    {
        ...
        private void btnClip_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Call algorithm
                _clippedPolygons = CWeilerAtherton.ClipPolygon(_subject, _clip);
                lblStatus.Text = $"Polígonos resultantes: {_clippedPolygons.Count}";
            }
        ...
        {
            try { pnlCanvas.Invalidate(); } catch { }
        }
    }
}
