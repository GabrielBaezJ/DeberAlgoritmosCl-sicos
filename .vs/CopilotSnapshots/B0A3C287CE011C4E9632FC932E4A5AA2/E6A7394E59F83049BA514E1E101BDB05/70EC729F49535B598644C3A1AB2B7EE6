...
namespace FormPartenerAndChild
{
    public partial class frmMidpointCircle : Form
    {
        ...
        private void btnDraw_Click(object sender, EventArgs e)
        {
            ...
            // Guardar centro en coordenadas del mundo (origen en el centro del panel)
            lastCenterX = xc;
            lastCenterY = yc;

            // Generar puntos con el algoritmo del punto medio usando el centro proporcionado
        ...
        private void pnlCanvas_Paint(object sender, PaintEventArgs e)
        {
            ...
            // Guardar estado y aplicar transformaciones: centrar y escalar
            ...
            // Dibujar cuadricula en coordenadas del mundo (se escala con zoom)
            int grid = 10; // tamaño de celda en unidades del mundo
            ...
            // Dibujar la circunferencia como polígono ordenado por ángulo alrededor del centro
